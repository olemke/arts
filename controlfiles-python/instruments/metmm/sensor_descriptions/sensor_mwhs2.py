...
mm = [
    [89.000e9, 0.0, 0.0, 1500e6],  # 0  (H1 )
    [118.750e9, 5.00e9, 0.0, 2000e6],  # 1  (H2 )
    [118.750e9, 3.00e9, 0.0, 1000e6],  # 2  (H3 )
    [118.750e9, 2.50e9, 0.0, 200e6],  # 3  (H4 )
    [118.750e9, 1.10e9, 0.0, 200e6],  # 4  (H5 )
    [118.750e9, 0.80e9, 0.0, 200e6],  # 5  (H6 )
    [118.750e9, 0.30e9, 0.0, 165e6],  # 6  (H7 )
    [118.750e9, 0.20e9, 0.0, 100e6],  # 7  (H8 )
    [118.750e9, 0.08e9, 0.0, 20e6],  # 8  (H9 )
    [150.000e9, 0.0, 0.0, 1500e6],  # 9  (H10)
    [183.311e9, 7.00e9, 0.0, 2000e6],  # 10 (H11)
    [183.311e9, 4.50e9, 0.0, 2000e6],  # 11 (H12)
    [183.311e9, 3.00e9, 0.0, 1000e6],  # 12 (H13)
    [183.311e9, 1.80e9, 0.0, 700e6],  # 13 (H14)
    [183.311e9, 1.00e9, 0.0, 500e6],  # 14 (H15)
]
...
ws.VectorSet(
    ws.freq_spacing_tmp,
    np.array(
        [10e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9]
    ),
)
