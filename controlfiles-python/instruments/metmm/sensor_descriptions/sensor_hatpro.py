...
mm = [
    [22.240e9, 0.0, 0.0, 230e6],  # 0  (HATPRO-01)
    [23.040e9, 0.0, 0.0, 230e6],  # 1  (HATPRO-02)
    [23.840e9, 0.0, 0.0, 230e6],  # 2  (HATPRO-03)
    [25.440e9, 0.0, 0.0, 230e6],  # 3  (HATPRO-04)
    [26.240e9, 0.0, 0.0, 230e6],  # 4  (HATPRO-05)
    [27.840e9, 0.0, 0.0, 230e6],  # 5  (HATPRO-06)
    [31.400e9, 0.0, 0.0, 230e6],  # 6  (HATPRO-07)
    [51.260e9, 0.0, 0.0, 182e6],  # 7  (HATPRO-08)
    [52.280e9, 0.0, 0.0, 179e6],  # 8  (HATPRO-09)
    [53.860e9, 0.0, 0.0, 188e6],  # 9  (HATPRO-10)
    [54.940e9, 0.0, 0.0, 170e6],  # 10 (HATPRO-11)
    [56.660e9, 0.0, 0.0, 704e6],  # 11 (HATPRO-12)
    [57.300e9, 0.0, 0.0, 927e6],  # 12 (HATPRO-13)
    [58.000e9, 0.0, 0.0, 1854e6],  # 13 (HATPRO-14)
    [90.000e9, 0.0, 0.0, 2000e6],  # 14 (HATPRO-15)
    [150.000e9, 0.0, 0.0, 2000e6],  # 15 (HATPRO-16)
]
